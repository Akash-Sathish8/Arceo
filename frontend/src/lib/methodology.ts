...
export const RISK_CHAIN_GLOSSARY = `A multi-step sequence that's only dangerous in combination. For example, "read customer PII then send an external email" is a data exfiltration path even though each step is innocuous alone.`
