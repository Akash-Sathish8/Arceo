...
const PLANS = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "For teams seeing an agent's blast radius and cost for the first time.",
    cta: "Get a free scan",
    ctaHref: "/book-demo",
  ...
  },
  {
    ...
    price: "$99",
    period: "/ month",
    description: "For teams putting multiple agents into production.",
